...
type Mutation {
  ...
  updateManyRatingses(data: RatingsUpdateManyMutationInput!, where: RatingsWhereInput): BatchPayload!
...
input PlaylistCreateManyWithoutPlaylistOwnerInput {
  create: [PlaylistCreateWithoutPlaylistOwnerInput!]
  connect: [PlaylistWhereUniqueInput!]
}

input PlaylistCreateWithoutPlaylistOwnerInput {
  media: MediaCreateManyInput
}
...
input PlaylistUpdateManyWithoutPlaylistOwnerInput {
  create: [PlaylistCreateWithoutPlaylistOwnerInput!]
  delete: [PlaylistWhereUniqueInput!]
  connect: [PlaylistWhereUniqueInput!]
  set: [PlaylistWhereUniqueInput!]
  disconnect: [PlaylistWhereUniqueInput!]
  update: [PlaylistUpdateWithWhereUniqueWithoutPlaylistOwnerInput!]
  upsert: [PlaylistUpsertWithWhereUniqueWithoutPlaylistOwnerInput!]
  deleteMany: [PlaylistScalarWhereInput!]
}

input PlaylistUpdateWithoutPlaylistOwnerDataInput {
  media: MediaUpdateManyInput
}

input PlaylistUpdateWithWhereUniqueWithoutPlaylistOwnerInput {
  where: PlaylistWhereUniqueInput!
  data: PlaylistUpdateWithoutPlaylistOwnerDataInput!
}

input PlaylistUpsertWithWhereUniqueWithoutPlaylistOwnerInput {
  where: PlaylistWhereUniqueInput!
